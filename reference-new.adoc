...
Cloud Volumes ONTAP 现在支持ONTAP 反勒索软件功能。此功能使用NAS (NFS和SMB)环境中的工作负载分析主动检测并警告可能指示勒索软件攻击的异常活动。

https://docs.netapp.com/us-en/ontap/anti-ransomware/index.html["了解有关反勒索软件的更多信息"^]

请注意、Cloud Manager不对此功能进行任何管理。您需要使用System Manager或CLI启用反勒索软件保护。

反勒索软件解决了与不同的使用情形 https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-protecting-ransomware.html["您可以通过Cloud Manager启用的勒索软件保护"^]
